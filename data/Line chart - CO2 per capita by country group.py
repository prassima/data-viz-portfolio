...
df['Classification'].fillna('Majority non-white', inplace= True)
...
pivoted_df.sort_values('Year').to_csv('data/Line chart - CO2 per capita by country group.csv', index=False)